...
// was used to experiment with endless dungeon generation
// This is not being used in the game
public class GeneratingDungeon : MonoBehaviour
{
    [SerializeField]
    private int lvlBoundWidth;
    [SerializeField]
    private int lvlBoundHeight;
    [SerializeField]
    private Vector2 MinAndMaxTrees;
    [SerializeField]
    private Vector2 MinAndMaxCamps;
    [SerializeField]
    private int CampWidthHalf;
    [SerializeField]
    private int CampHeigthHalf;
    [SerializeField]
    private int amountOfItemsInCamp;
    [SerializeField]
    private GameObject[] groundBlockPrefabs;
    [SerializeField]
    private GameObject[] itemBlockPrefabs;
    [SerializeField]
    private GameObject[] wallBlockPrefabs;
    [SerializeField]
    private GameObject lvlParent;
